    ...
    return (
        <section id={'certificate'}>
            ...
            <div className="other">
                ...
                <span className="time"><time dateTime="2021-08">2021.08.20</time> ~ ∞</span>
            </div>

            <div className="other">
                <h3>TOPCIT 3수준 (소프트웨어 역량검정)<span className="period-mark">.</span></h3>
                <span className="role">정보통신기획평가원</span>
                <span className="time"><time dateTime="2021-05">2021.05.22</time> ~ ∞</span>
            </div>
            <div className="other">
                <h3>ADSP(데이터분석준전문가)<span className="period-mark">.</span></h3>
                <span className="role">한국데이터산업진흥원</span>
                <span className="time"><time dateTime="2020-09">2020.09.29</time> ~ ∞</span>
            </div>
        </section>
    );
}
